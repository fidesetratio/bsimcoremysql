...
public class ParameterClass implements Serializable {
	...
	private Double mps_prm_deposit;
	...
	public Double getLsrid_kali_up() {
		return lsrid_kali_up;
	}
	...
	public void setLsrid_kali_up(Double lsrid_kali_up) {
		this.lsrid_kali_up = lsrid_kali_up;
	}
	...
	public void setMspoAge(Integer mspoAge) {
		this.mspoAge = mspoAge;
	}
