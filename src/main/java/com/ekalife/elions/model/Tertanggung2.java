...
public class Tertanggung2 implements Serializable {
	...
	private Integer lwk_id;
	private Integer lsrg_id;
	...
	public String getLside_nama() {
		return lside_nama;
	}
	public void setLside_nama(String lside_nama) {
		this.lside_nama = lside_nama;
	}
	...
	public Integer getLsrg_id() {
		return lsrg_id;
	}
	public void setLsrg_id(Integer lsrg_id) {
		this.lsrg_id = lsrg_id;
	}
	public Integer getLwk_id() {
		return lwk_id;
	}
	public void setLwk_id(Integer lwk_id) {
		this.lwk_id = lwk_id;
	}
